    ...
    <form action="actions/admin/client/execute_client_update.php" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="tel" id="number" name="number" value="<?= htmlspecialchars($client->getNumber()) ?>"
            ...
            <div>
                ...
                <input type="text" id="name" name="name" value="<?= htmlspecialchars($client->getName()) ?>"
                       class="w-full border px-4 py-2 rounded-lg focus:ring-2 focus:ring-blue-500" required>
            </div>

            <div>
                <label class="block font-medium mb-1" for="email">Email</label>
                <input type="email" id="email" name="email" value="<?= htmlspecialchars($client->getEmail()) ?>"
                       class="w-full border px-4 py-2 rounded-lg focus:ring-2 focus:ring-blue-500" required>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="md:col-span-2">
                ...
                <input type="text" id="street" name="street" value="<?= htmlspecialchars($client->getAddress()->getStreet()) ?>"
                       class="w-full border px-4 py-2 rounded-lg focus:ring-2 focus:ring-blue-500">
            </div>
            <div>
                <label class="block font-medium mb-1" for="address_number">Número</label>
                <input type="text" id="address_number" name="address_number" value="<?= htmlspecialchars($client->getAddress()->getNumber()) ?>"
                       class="w-full border px-4 py-2 rounded-lg focus:ring-2 focus:ring-blue-500">
            </div>

            <div>
                <label class="block font-medium mb-1" for="complement">Complemento</label>
                <input type="text" id="complement" name="complement" value="<?= htmlspecialchars($client->getAddress()->getComplement()) ?>"
                       class="w-full border px-4 py-2 rounded-lg focus:ring-2 focus:ring-blue-500">
            </div>

            <div>
                <label class="block font-medium mb-1" for="neighborhood">Bairro</label>
                <input type="text" id="neighborhood" name="neighborhood" value="<?= htmlspecialchars($client->getAddress()->getNeighborhood()) ?>"
                       class="w-full border px-4 py-2 rounded-lg focus:ring-2 focus:ring-blue-500">
            </div>

            <div>
                <label class="block font-medium mb-1" for="city">Cidade</label>
                <input type="text" id="city" name="city" value="<?= htmlspecialchars($client->getAddress()->getCity()) ?>"
                       class="w-full border px-4 py-2 rounded-lg focus:ring-2 focus:ring-blue-500">
            </div>

            <div>
                <label class="block font-medium mb-1" for="state">Estado</label>
                <input type="text" id="state" name="state" value="<?= htmlspecialchars($client->getAddress()->getState()) ?>"
                       class="w-full border px-4 py-2 rounded-lg focus:ring-2 focus:ring-blue-500">
            </div>

            <div>
                <label class="block font-medium mb-1" for="zip">CEP</label>
                <input type="text" id="zip" name="zip" value="<?= htmlspecialchars($client->getAddress()->getZip()) ?>"
                       class="w-full border px-4 py-2 rounded-lg focus:ring-2 focus:ring-blue-500">
            </div>
        </div>

...
<section class="min-h-screen bg-gray-100 py-12 px-6">
    <div class="max-w-4xl mx-auto bg-white p-6 rounded-xl shadow">
        ...
        <p class="mb-6"><strong>Envio previsto:</strong> <?= $order->getShippingDate() ? $order->getShippingDate()->format('d/m/Y') : ($order->getStatus() == Status::Rejected ? "Pedido Cancelado" : 'Indefinido') ?></p>
